...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 33zJeJzqHDH0/css
import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: rmkTBqq_i_NM/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__gMpcU)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__ioeO7)}
              role={"img"}
            />
          ),
